...
* **社区版</br>**
  员工小于200人或营业收入低于5000万的中小企业可以免费使用。
...
* **商业版</br>**
  我们提供可以私有化部署的商业版，具有包括不限于打通企微、钉钉、飞书组织架构等企业级产品特性，如果你需要个性化定制，也可以通过[电子邮件](mailto\:hub@53ai.com?subject=\[GitHub]个性定制)讨论你的个性化定制需求。 </br>
